(function () {
    ...
    function getThemeColors(userTheme) {
        ...
        return {userBackground, userText};
    }
    function setThemeColors(background, text, props) {
    ...
    function ThemePicker(props) {
        ...
        const selectedTheme =
            (_a = Object.values(builtInThemes).find(([bg, text]) => {
        ...
        const plusLayout = m$1(
            ...
            m$1(
                "div",
                {class: "x-theme-picker__custom-theme-container"},
                m$1(
                    "span",
                    {
                        class: {
                            "x-theme-picker__custom-theme": true,
                            "x-theme-picker__custom-theme--custom-colors":
                                isCustomTheme
                        },
                        style: isCustomTheme
                            ? {
                    ...
                    m$1(
                        "i",
                        {
                            class: "x-theme-picker__custom-theme__icon x-theme-picker__custom-theme__icon--left"
                        },
                        isCustomTheme
                            ? m$1(CheckIcon, null)
                            : m$1(AddSmallIcon, null)
                    ...
                    m$1(
                        "span",
                        {class: "x-theme-picker__custom-theme__text"},
                        isCustomTheme ? "Custom colors" : "Create your theme"
                    ),
                    m$1(
                        "i",
                        {class: "x-theme-picker__custom-theme__icon"},
                        m$1(SettingsIcon, null)
                    )
                )
            ),
            m$1(
                "div",
                {class: "x-theme-picker__themes"},
                plusThemes.map(({key, theme}) => {
                    const parts = key.split(" ");
                    const text =
                        parts.length > 1
                            ? `${parts[0][0].toLocaleUpperCase()}${parts[1][0].toLocaleLowerCase()}`
                            : `${key[0].toLocaleUpperCase()}${key[key.length - 1].toLocaleLowerCase()}`;
                    return m$1(
                        ThemeButton,
                        {
                            backgroundColor: theme[0],
            ...
            m$1("div", {class: "x-theme-picker__theme-name"}, selectedThemeName)
        );
        return m$1(
            "div",
            {class: "x-theme-picker"},
            plus ? plusLayout : defaultLayout
        );
    }
    ...
    function MobileLinks() {
        return m$1(
            ...
            m$1(
                "div",
                {class: "x-mobile-links"},
                m$1(
                    "div",
                    {class: "x-mobile-links__qr"},
                    m$1(
                        "div",
                        {class: "x-mobile-links__qr-wrapper"},
                        m$1("img", {src: "/plus/assets/qr-code.png"}),
                        "Scan & Install"
                    )
                ),
                m$1(
                    "div",
                    {class: "x-mobile-links__subtitle"},
                    m$1(
                        "a",
                        {
                            "class": "x-mobile-links__text-link",
                            "href": MOBILE_URL,
                            "target": "_blank",
                            "rel": "noopener",
                            "data-s": "drios-side-text"
                        },
                        m$1(
                            "span",
                            {class: "x-mobile-links__text-link__darkreader"},
                            "Dark Reader"
                        ),
                        " Mobile"
                    )
                ...
                m$1(
                    "div",
                    {class: "x-mobile-links__description"},
                    m$1("strong", null, "Take care of your eyes"),
                    m$1("br", null),
                    "Take dark mode with you"
                ),
                m$1(
                    "div",
                    {class: "x-mobile-links__icons"},
    ...
    function MainPage(props) {
        return m$1(
            ...
            m$1("section", null, m$1(ThemePicker, {...props})),
    ...
    function ThemePage(props) {
        ...
        function setColors(background, text) {
            setThemeColors(background, text, props);
        }
        return m$1(
            "div",
            {class: "x-theme-page"},
            ...
            m$1(
                "div",
                {class: "x-theme-page__add-button"},
                m$1(
                    "span",
                    {class: "x-theme-page__add-button__icon"},
                    m$1(AddIcon, null)
                ),
                "Create your theme"
            )
    ...
    function HslSliders(props) {
        ...
        return m$1(
            "div",
            {
                class: "x-hsl",
                style: {
                    "--x-hsl-hue": `${sourceHsl.h.toFixed(0)}deg`,
                    "--x-hsl-saturation": `${(sourceHsl.s * 100).toFixed(0)}%`,
                    "--x-hsl-lightness": `${(sourceHsl.l * 100).toFixed(0)}%`
                }
            },
            m$1(SliderBlock, {
                class: "x-hsl__hue",
            ...
            m$1(SliderBlock, {
                ...
                min: 0,
                max: 100,
                value: sourceHsl.l * 100,
                step: 1,
                format: (x) => `${x}%`,
                onChange: (x) => {
                    const l = (x !== null && x !== void 0 ? x : 0) / 100;
                    const newHsl = {...sourceHsl, l};
                    const newHex = rgbToHexString(hslToRGB(newHsl));
                    props.onColorChange(newHex, newHsl);
                },
                onPreview: (x) => {
        ...
        return m$1(
            ...
            bgPalette.map((background) => {
                ...
                return m$1("span", {
                    ...
                    onclick: () => setColors(background, text)
                });
            })
        );
    }
            ...
            textPalette.map((textColor) => {
                return m$1(
                    "span",
                    {
                        ...
                        onclick: () => {
                            setColors(userBackground, textColor);
                        }
                    },
                    "Text"
                );
                    ...
                    m$1(HslSliders, {
                        ...
                        onColorPreview: (newBg, newHsl) => {
                            ...
                            if (store.bgPreviewNode.firstChild) {
                                store.bgPreviewNode.firstChild.textContent =
                                    newBg;
                            }
                        }
                    })
                        ...
                        m$1(
                            ...
                            m$1(HslSliders, {
                                ...
                                onColorChange: (newText) => {
                                    setColors(userBackground, newText);
                                },
                                onColorPreview: (newText) => {
                                    if (store.textPreviewNode) {
                                        store.textPreviewNode.style.color =
                                            newText;
                ...
                m$1(
                    ...
                    m$1(
                        ...
                        m$1(CheckGroup, {
                            ...
                            label: "Filter mode",
                            description:
                                "Works faster, but is less accurate and affects images"
                        }),
                        m$1(SliderBlock, {
                            class: "x-filter x-filter__brightness",
                            label: "Brightness",
                        ...
                        m$1(CheckGroup, {
                            ...
                            label: "Invert colors",
                            description:
                                "Make the background dark and the texts light"
                        }),
                        m$1(CheckGroup, {
                            type: "toggle",
                            class: "x-filter__svg",
                            ...
                            label: "SVG filter",
                            description:
                                "Works better with colors, but may be prone to browser bugs"
                        })
                    )
                )
            )
